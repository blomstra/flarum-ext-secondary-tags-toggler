...
/***/ "./src/forum/components/ToggleableTagLabel.tsx":
/*!*****************************************************!*\
  !*** ./src/forum/components/ToggleableTagLabel.tsx ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ToggleableTagLabel; });
...
/* harmony import */ var flarum_tags_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flarum/tags/helpers/tagIcon */ "flarum/tags/helpers/tagIcon");
/* harmony import */ var flarum_tags_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flarum_tags_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _utils_isTagOnDiscussion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/isTagOnDiscussion */ "./src/forum/utils/isTagOnDiscussion.ts");
...
var ToggleableTagLabel = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(ToggleableTagLabel, _Component);

  function ToggleableTagLabel() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = ToggleableTagLabel.prototype;
  ...
  _proto.view = function view() {
    ...
    var _this$attrs = this.attrs,
        ...
        tagModel = _this$attrs.tagModel;
    var isTagEnabled = Object(_utils_isTagOnDiscussion__WEBPACK_IMPORTED_MODULE_6__["default"])(discussion, tagModel);
    var uniqueId = Object(nanoid__WEBPACK_IMPORTED_MODULE_7__["nanoid"])();
    var tagText = tagModel ? tagModel.name() : flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default.a.translator.trans('flarum-tags.lib.deleted_tag_text');

    if (tagModel) {
      var color = tagModel.color();

      if (color) {
        domAttrs.style['--tag-bg'] = color;
        domAttrs.className = flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()(domAttrs.className, 'colored');
      }

      if (tagModel.isChild()) {
        domAttrs.className = flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()(domAttrs.className, 'TagLabel--child');
      }
    } else {
      domAttrs.className = flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()(domAttrs.className, 'untagged');
    }

    return m("span", domAttrs, m("input", {
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _this.attrs.onBeginChange(); // Tag ID to Tag map


                  discussionTags = discussion.tags().reduce(function (acc, tag) {
                    acc[tag.id()] = tag;
                    return acc;
                  }, {});
                  ...
                  return discussion.save({
                    relationships: {
                      tags: Object.values(discussionTags)
                    }
                  });

                case 5:
                  _this.attrs.onChangeComplete();
    ...
    }, tagModel && tagModel.icon() && flarum_tags_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_5___default()(tagModel, {}, {
      useColor: false
    }), " ", tagText));
  };

  return ToggleableTagLabel;
...
/***/ "./src/forum/components/ToggleableTagLabelList.tsx":
/*!*********************************************************!*\
  !*** ./src/forum/components/ToggleableTagLabelList.tsx ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ToggleableTagLabelSet; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_common_Component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/common/Component */ "flarum/common/Component");
/* harmony import */ var flarum_common_Component__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_common_Component__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ToggleableTagLabel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ToggleableTagLabel */ "./src/forum/components/ToggleableTagLabel.tsx");




var ToggleableTagLabelSet = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(ToggleableTagLabelSet, _Component);

  function ToggleableTagLabelSet() {
    var _this;
  ...
  var _proto = ToggleableTagLabelSet.prototype;

  _proto.view = function view() {
    var _this2 = this;

    var _this$attrs = this.attrs,
        allSecondaryTags = _this$attrs.allSecondaryTags,
        discussion = _this$attrs.discussion;
    return m("span", {
      "class": "BlomstraToggleableTagLabels"
    }, allSecondaryTags == null ? void 0 : allSecondaryTags.map == null ? void 0 : allSecondaryTags.map(function (tag) {
      return m(_ToggleableTagLabel__WEBPACK_IMPORTED_MODULE_2__["default"], {
        key: tag.id(),
        tagModel: tag,
        discussion: discussion,
        disabled: _this2.state.disabled,
        onBeginChange: function onBeginChange() {
          _this2.state.disabled = true;
          m.redraw();
        },
...
/* harmony import */ var _components_ToggleableTagLabelList__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/ToggleableTagLabelList */ "./src/forum/components/ToggleableTagLabelList.tsx");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default.a.initializers.add('blomstra/secondary-tags-toggler', function () {
  var allSecondaryTags = null;
  setTimeout( /*#__PURE__*/Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default.a.store;
            _context.next = 3;
            return flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default.a.request({
              url: flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('apiUrl') + '/blomstra-secondary-tags-toggle/all-secondary-tags',
              method: 'GET'
            });

          case 3:
            _context.t1 = _context.sent;
            tags = _context.t0.pushPayload.call(_context.t0, _context.t1);
            delete tags.payload;
            allSecondaryTags = flarum_tags_utils_sortTags__WEBPACK_IMPORTED_MODULE_5___default()(tags);
            m.redraw();
  ...
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_4__["extend"])(flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'items', function (items) {
    var discussion = this.attrs.discussion;
    if (!discussion.canTag()) return;
    if (allSecondaryTags === null) return;
    items.add('secondaryTagsToggle', m(_components_ToggleableTagLabelList__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/***/ "./src/forum/utils/isTagOnDiscussion.ts":
/*!**********************************************!*\
  !*** ./src/forum/utils/isTagOnDiscussion.ts ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isTagOnDiscussion; });
function isTagOnDiscussion(discussion, tag) {
  return discussion.tags().some(function (t) {
    return t.id() === tag.id();
  });
}
